...
<template>
  <div ref="tabs" class="tabs">
    <ClientOnly>
      <div
        class="tabs-header relative overflow-hidden flex space-x-6 text-sm font-bold text-gray-300 bg-primary-800 rounded-t-lg px-5 py-3"
      >
        <div
        ...
        <span
          ...
          :style="{ zIndex: 1 }"
        >
          <span class="flex-1 bg-primary-900 rounded-lg" />
        </span>
      </div>
    </ClientOnly>
    <div
      class="tabs-body relative text-gray-800 dark:text-white bg-gray-200 dark:bg-zinc-800 shadow rounded-b-lg"
    >
      <slot />
    </div>
  </div>
